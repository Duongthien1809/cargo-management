...
import utils.AlternativeEvenGenerator;
...
public class AlternativeConsole {
    ...
    public AlternativeConsole(EventHandler eventHandler) {
        this.eventHandler = eventHandler;
    }

    public AlternativeConsole(client.Client client) {
        this.client = client;
    }
    ...
    void handleInput(String status, String input) {
        ...
        EventObject event = AlternativeEvenGenerator.createEvent(status, inputArr);
